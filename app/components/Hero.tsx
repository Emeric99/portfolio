  ...
  return (
    ...
    >
      ...
      <div className="absolute inset-0 pointer-events-none"
        style={{ background: "radial-gradient(ellipse 60% 50% at 50% 55%, rgba(0,176,80,0.1) 0%, transparent 70%)" }}
      />
      ...
      <div className="relative z-10 flex flex-col items-center text-center px-8 max-w-4xl mx-auto">
        ...
        >
          <a
            ...
            target="_blank"
            className="flex items-center gap-2 bg-transparent border border-[#00b050]/50 text-white text-sm font-medium px-6 py-2.5 rounded-full transition-all duration-200 hover:border-[#00d462] hover:text-[#00d462] hover:scale-105 hover:shadow-[0_0_18px_rgba(0,180,80,0.45)]"
          >
        ...
        {/* Scroll indicator — éclair MHA */}
        <motion.a
          href="#about"
          animate={{ opacity: [0, 1, 1, 1, 0] }}
          transition={{ duration: 2, repeat: Infinity, repeatDelay: 0.5, ease: "easeInOut" }}
          className="flex flex-col items-center gap-1 text-[#00b050] hover:text-[#00d462] transition-colors"
        >
          <span className="text-xs tracking-widest uppercase font-semibold">{t.scroll}</span>
          <motion.div
            animate={{ y: [0, 8, 0] }}
            transition={{ duration: 1, repeat: Infinity, ease: "easeInOut" }}
          >
            {/* Éclair — symbole One For All */}
            <svg className="w-5 h-7" viewBox="0 0 20 28" fill="currentColor">
              <path d="M13 0L3 16h7l-3 12L17 12h-7z" />
            </svg>
          </motion.div>
        </motion.a>
      </div>
