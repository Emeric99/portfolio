      ...
      <div className="relative z-10 flex flex-col items-center text-center px-8 max-w-4xl mx-auto">
        ...
        >
          <a
            ...
            target="_blank"
            className="flex items-center gap-2 bg-[#00b050]/20 hover:bg-[#00b050]/35 border border-[#00b050]/50 text-[#00d462] text-sm font-medium px-6 py-2.5 rounded-full transition-colors"
          >
        ...
        <motion.a
          ...
          className="flex flex-col items-center gap-1 text-zinc-500 hover:text-[#00d462] transition-colors group"
        >
          ...
          >
            <svg className="w-4 h-4 group-hover:text-[#00d462]" fill="none" stroke="currentColor" strokeWidth={2} viewBox="0 0 24 24">
