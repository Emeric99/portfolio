      ...
      <div className="relative z-10 flex flex-col items-center text-center px-8 max-w-4xl mx-auto">
        ...
        >
          <a
            ...
            target="_blank"
            className="flex items-center gap-2 bg-transparent border border-[#00b050]/50 text-white text-sm font-medium px-6 py-2.5 rounded-full hover:border-[#00d462] hover:text-[#00d462] transition-colors"
          >
        ...
        <motion.a
          ...
          transition={{ delay: 1, duration: 2.5, repeat: Infinity, repeatDelay: 1, ease: "easeInOut" }}
          className="flex flex-col items-center gap-2 text-zinc-500 hover:text-[#00d462] transition-colors"
        >
          <motion.div
            animate={{ scaleY: [0, 1] }}
            transition={{ delay: 1, duration: 1, repeat: Infinity, repeatDelay: 2.5, ease: "easeInOut" }}
            style={{ originY: 0 }}
            className="w-px h-8 bg-zinc-500"
          />
